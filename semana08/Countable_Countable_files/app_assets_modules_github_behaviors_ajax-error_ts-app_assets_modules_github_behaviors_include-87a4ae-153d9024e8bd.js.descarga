"use strict";(globalThis.webpackChunk=globalThis.webpackChunk||[]).push([["app_assets_modules_github_behaviors_ajax-error_ts-app_assets_modules_github_behaviors_include-87a4ae","ui_packages_soft-navigate_soft-navigate_ts"],{86788:(e,t,r)=>{r.d(t,{a:()=>a,n:()=>i});var n=r(97797);function i(){let e=document.getElementById("ajax-error-message");e&&(e.hidden=!1)}function a(){let e=document.getElementById("ajax-error-message");e&&(e.hidden=!0)}(0,n.on)("deprecatedAjaxError","[data-remote]",function(e){let{error:t,text:r}=e.detail;e.currentTarget===e.target&&"abort"!==t&&"canceled"!==t&&(/<html/.test(r)?(i(),e.stopImmediatePropagation()):setTimeout(function(){e.defaultPrevented||i()},0))}),(0,n.on)("deprecatedAjaxSend","[data-remote]",function(){a()}),(0,n.on)("click",".js-ajax-error-dismiss",function(){a()})},74201:(e,t,r)=>{r.d(t,{A:()=>s,L:()=>l});var n=r(17688),i=r(21403),a=r(97797),o=r(11707);let d=new WeakMap;function s(e){let t=e.closest(".js-render-needs-enrichment");t&&(t.classList.remove("render-error"),d.get(t)?.setLoading(!1))}function l(e,t){let r=e.closest(".js-render-needs-enrichment");return!!r&&(r.classList.add("render-error"),d.get(r)?.setError(!0,t))}function c(e,t,r){let i=r.identifier??"",a=new URL(e,window.location.origin);for(let[e,r]of Object.entries(t))a.searchParams.append(e,`${r}`);return a.hash=i,(0,n.qy)`
    <div
