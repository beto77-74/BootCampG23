...
const fetchMovies = async () => {
    ...
    const options = {
      ...
      const response = await fetch('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=es-US&page=1&sort_by=popularity.desc', options)
